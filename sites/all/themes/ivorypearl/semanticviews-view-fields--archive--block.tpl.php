...
<?php foreach ($fields as $id => $field): ?>
  ...
  <?php if ($field->element_type): ?>
    <<?php print $field->element_type; ?><?php print drupal_attributes($field->attributes); ?>><p>Test</p>
  <?php endif; ?>

    <?php if ($field->label): ?>

      <?php if ($field->label_element_type): ?>
        <<?php print $field->label_element_type; ?><?php print drupal_attributes($field->label_attributes); ?>><p>Test</p>
      <?php endif; ?>

          <?php print $field->label; ?>:

      <?php if ($field->label_element_type): ?>
        </<?php print $field->label_element_type; ?>><p>Test</p>
      <?php endif; ?>
...
<p>Test</p>
  ...
  <?php if ($field->element_type): ?>
    </<?php print $field->element_type; ?>><p>Test</p>
  <?php endif; ?>
